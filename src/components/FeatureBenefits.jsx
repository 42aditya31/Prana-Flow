...
const FeatureBenefits = () => {
  const data = [
    ...
    {
      id: 3,
      image: "https://img.freepik.com/free-vector/quality-work-abstract-concept-vector-illustration-quality-workplace-employee-performance-experienced-worker-speed-production-improvement-effective-management-abstract-metaphor_335657-6296.jpg?t=st=1734668284~exp=1734671884~hmac=8794f141b7257c59327e089fe29f012e1786231afb98d6936c58e7e397fe6c24&w=740",
        ...
        <button
          className={`px-8 py-3 font-semibold border transition-all duration-300 ${
            toggleActive === "FirstHalf"
              ...
              : "bg-[#073B4C] text-white border-gray-300 "
          } rounded-l-full`}
